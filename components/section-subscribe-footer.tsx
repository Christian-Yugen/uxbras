...
const SectionSubscribeFooter:NextPage<SectionSubscribeFooterType> = ({ className="" }) => {
  return (
    <div className={[styles.sectionSubscribeFooter, className].join(' ')}>
      ...
      <div className={styles.emailInput}>
        <div className={styles.input}>
          <input className={styles.emailAddress} placeholder="Email Address" type="text" />
        </div>
      </div>
